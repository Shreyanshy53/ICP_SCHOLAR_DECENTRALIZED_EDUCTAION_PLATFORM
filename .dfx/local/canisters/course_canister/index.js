...
export const canisterId = process.env.COURSE_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./course_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the course_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./course_canister.did.js")._SERVICE>}
 */
