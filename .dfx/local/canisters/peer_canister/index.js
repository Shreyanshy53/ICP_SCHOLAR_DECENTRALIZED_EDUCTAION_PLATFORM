...
import { idlFactory } from './peer_canister.did.js';
export { idlFactory } from './peer_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PEER_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./peer_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the peer_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./peer_canister.did.js")._SERVICE>}
 */
export const peer_canister = createActor(canisterId);
