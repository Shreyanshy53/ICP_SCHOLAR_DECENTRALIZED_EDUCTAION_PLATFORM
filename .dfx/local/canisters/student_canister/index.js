...
export const canisterId = process.env.STUDENT_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./student_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the student_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./student_canister.did.js")._SERVICE>}
 */
